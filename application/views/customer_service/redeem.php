...
<div class="row">
    <div class="page-header">
      <div class="d-flex align-items-center">
          <h2 class="page-header-title">Redeem</h2>
          <div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item active"><a href="#/dashboard"><i class="la la-home"></i></a> - <a href="#/dashboard">Dashboard</a> - Redeem </li>
            </ul>
          </div>
      </div>
    </div>
...
<script>
	$(document).ready(function(){
		var link_get = '<?= base_url('api/redeem/show/'); ?>'+auth.token
	    var t_claim = $('#t_claim').DataTable({
	      ...
	      columns: [
	        {"data": null, 'render': function(data, type, row){
                return `<a href="#/redeem/${row.id_redeem}">${row.id_redeem}</a>`;
				}
			},
