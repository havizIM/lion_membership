        ...
        <div class="widget-body">
            <div class="row">
                ...
                <div class="col-md-5 col-5 d-flex justify-content-center align-items-center">
                    <div class="visitors">
                        <div class="percent"><i class="la la-circle-o text-danger" style="font-size: 75px"></i></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="widget widget-17 has-shadow">
        <div class="widget-body">
            <div class="row">
                ...
                <div class="col-md-5 col-5 d-flex justify-content-center align-items-center">
                    <div class="visitors">
                        <div class="percent"><i class="la la-user text-warning" style="font-size: 75px"></i></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-body">
            <div class="row">
                <div class="col-md-7 col-7 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="total-visitors" style="font-size:13px; padding-bottom:5px">Total Data Claim</div>
                </div>
                <div class="col-md-5 col-5 d-flex justify-content-center align-items-center">
                    <div class="visitors">
                        <div class="percent"><i class="la la-caret-square-o-down text-info" style="font-size: 75px"></i></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="widget-body">
            <div class="row">
                <div class="col-md-7 col-7 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="total-visitors" style="font-size:13px;">Total Data Redeem</div>
                </div>
                <div class="col-md-5 col-5 d-flex justify-content-center align-items-center">
                    <div class="visitors">
                        <div class="percent"><i class="la la-star text-success" style="font-size: 75px"></i></div>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var data1 = `<?= base_url().'api/poin/show/' ?>${token}`
    var data2 = `<?= base_url().'api/member/show/' ?>${token}`
    var data3 = `<?= base_url().'api/claim/show/' ?>${token}`
    var data4 = `<?= base_url().'api/reedem/show/' ?>${token}`
