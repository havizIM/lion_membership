            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Verification Mail</td>
                    </tr>
                  </table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Verification code: <b><?= $verify_code ?></b>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hi Pessenger..</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Berikut diatas adalah kode verifikasi yang digunakan untuk mendaftarkan pengajuan Lion Passport Card.
                            </td>
                          </tr>
                        </table>
