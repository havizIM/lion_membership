            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Pengajuan Lion Passport Card</td>
                    </tr>
                  </table>
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hi <?= $nama_customer ?>,</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Pengajuan dengan nomer <?= $no_aplikasi ?> ini diterima. Berikut adalah akun untuk mengakses sistem kami.
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Terimakasih!</p>
                              <p class="body-signature"><?= $sender ?></p>
                            </td>
                          </tr>
                        </table>
                      </td>
