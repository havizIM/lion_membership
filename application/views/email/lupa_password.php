            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Forgot Password Mail</td>
                    </tr>
                  </table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Verification code: <b><?= $password ?></b>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hi <?= $nama ?>..</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Berikut diatas adalah password baru yang digunakan untuk mendaftarkan pengajuan Lion Passport Card. Lakukan ganti password kembali agar keamanan akun lebih terjaga.
                            </td>
                          </tr>
                        </table>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Terima kasih,</p>
                              <p class="body-signature">Admin LPS</p>
                            </td>
                          </tr>
                        </table>
                      </td>
