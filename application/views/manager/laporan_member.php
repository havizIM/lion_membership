<div class="row">
    <div class="page-header">
      <div class="d-flex align-items-center">
          <h2 class="page-header-title">Laporan Member</h2>
          <div>
            <ul class="breadcrumb">
                <li class="breadcrumb-item active"><a href="#/dashboard"><i class="la la-home"></i></a> - <a href="#/dashboard">Dashboard</a> - Laporan Member </li>
            </ul>
          </div>
      </div>
    </div>
                            ...
                            <div class="invoice has-shadow printableArea">
                                <div class="invoice-container">
                                    ...
                                    <div class="invoice-date d-flex justify-content-xl-end justify-content-center">
                                        <span>Laporan Member Per ${list_bulan[bulan-1]} - ${tahun}</span>
                                    </div>
                                    <div class="col-xl-12 desc-tables">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        <th class="text-left">No Member</th>
                                                ...
                                                <tbody>`
                                                    ...
                                                    if(data.length === 0){
                                                        ...
                                                        $.each(data, function(k, v){
                                                            html += `
                                                                <tr>
                                                                    <td class="text-left">${v.no_member}</td>
                                                                    <td class="text-left">${v.gender}. ${v.nama}</td>
                                                                    <td class="text-left">${v.email}</td>
                                                                    <td class="text-left">${v.no_handphone}</td>
                                                                </tr>
                                                            `
                                                        })
                                                    }
                                    ...
                                    <div class="invoice-container">
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-xl-6 col-md-6 col-sm-6 d-flex justify-content-xl-end justify-content-md-end justify-content-center">
                                                <div class="total">
                                                    <div class="title">Total Member Terdaftar</div>
                                                    <div class="number">${data.length} Member</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        var submitLaporan = () => {
            $('#form_laporan').on('submit', function(e){
                ...
                if(bulan === '' || tahun === ''){
                    ...
                    $.ajax({
                        url: `<?= base_url('api/member/laporan/') ?>${auth.token}?bulan=${bulan}&tahun=${tahun}`,
                        type: 'GET',
                        dataType: 'JSON',
                        beforeSend: function(){
