                ...
                html +=`<div class="widget has-shadow">
                        ...
                        <div class="widget has-shadow">
                            ...
                            <div class="widget-body text-center">`
								...
								html+= `<button type="button" class="btn btn-md btn-primary" id="aktivasi_member" data-id="${data.no_member}"><i class="mdi mdi-check"></i>Aktifkan</button>`
							}else{
								html+= `<button type="button" class="btn btn-md btn-primary" id="nonaktif_member" data-id="${data.no_member}"><i class="mdi mdi-close"></i>Nonaktifkan</button>`
							}
                    html+= `</div>
                        </div>
