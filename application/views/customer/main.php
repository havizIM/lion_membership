                                        ...
                                        <div class="row d-flex align-items-center">
                                            ...
                                            <div class="col-xl-4 col-md-4 d-flex justify-content-center">
                                                <div class="image-default">
                                                    <img class="rounded-circle" src="<?= base_url() ?>assets/img/avatar/avatar-01.jpg" alt="...">
                                                </div>
                                                <div class="infos">
                                                    <h2>David Green</h2>
                                        ...
                                        <div class="widget has-shadow">
                                                ...
                                                <div class="col-xl-8 col-md-8 col-7 no-padding d-flex justify-content-start">
                                                    <div class="users-like">
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-01.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-02.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-03.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-09.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                            ...
                                            <div class="comments">
                                                <div class="comments-header d-flex align-items-center">
                                                    <div class="user-image">
                                                        <img class="rounded-circle" src="<?= base_url() ?>assets/img/avatar/avatar-05.jpg" alt="...">
                                                    </div>
                                                    <div class="d-flex flex-column mr-auto">
                                                        <div class="title">
                                            ...
                                            <div class="reply">
                                                <div class="reply-header d-flex align-items-center">
                                                    <div class="user-image">
                                                        <img class="rounded-circle" src="<?= base_url() ?>assets/img/avatar/avatar-02.jpg" alt="...">
                                                    </div>
                                                    <div class="d-flex flex-column mr-auto">
                                                        <div class="title">
                                            ...
                                            <div class="reply">
                                                <div class="reply-header d-flex align-items-center">
                                                    <div class="user-image">
                                                        <img class="rounded-circle" src="<?= base_url() ?>assets/img/avatar/avatar-06.jpg" alt="...">
                                                    </div>
                                                    <div class="d-flex flex-column mr-auto">
                                                        <div class="title">
                                        ...
                                        <div class="widget has-shadow">
                                            ...
                                            <div class="widget-body">
                                                <div class="content-img">
                                                    <a href="javascript:void(0);">
                                                        <img src="<?= base_url() ?>assets/img/background/01.jpg" class="img-fluid rounded" alt="...">
                                                    </a>
                                                </div>
                                            </div>
                                            <!-- End Widget Body -->
                                            ...
                                            <div class="widget-footer d-flex align-items-center">
                                                <div class="col no-padding d-flex justify-content-start">
                                                    <div class="users-like">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-05.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-07.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-04.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="comments">
                                                <div class="comments-header d-flex align-items-center">
                                                    <div class="user-image">
                                                        <img class="rounded-circle" src="<?= base_url() ?>assets/img/avatar/avatar-03.jpg" alt="...">
                                                    </div>
                                                    <div class="d-flex flex-column mr-auto">
                                                        <div class="title">
                                            ...
                                            <div class="widget-body">
                                                <div class="friends-list">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a href="javascript:void(0);">
                                                            <img src="<?= base_url() ?>assets/img/avatar/avatar-06.jpg" class="img-fluid rounded-circle" alt="...">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="widget-body p-3">
                                                <div class="row m-0">
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/01.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/02.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/03.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/04.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/05.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                    <div class="col-xl-6 col-md-6 col-6 p-0">
                                                        <a href="javascript:void(0);">
                                                            <img class="img-fluid rounded border border-white" src="<?= base_url() ?>assets/img/background/06.jpg" alt="...">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
